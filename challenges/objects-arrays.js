...
graduates.forEach(mail => {
  contactInfo.push(`${mail.first_name} ${mail.email}`)
}) 
...
*/
const lowPopulationAnimals = zooAnimals.filter(mammals => mammals.population < 5)
...
*/
const populationTotal = zooAnimals.reduce((accumilator, currentValue) => {
  return accumilator + currentValue.population
}, 0)
